      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            // punti dopo vittoria: usa solo score
            if (showPointsScreen)
              Positioned.fill(
                child: Container(
                  ...
                  child: Center(
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Image.asset("assets/images/points.png", width: 150, fit: BoxFit.contain),
                        const SizedBox(height: 20),
                        Text(
                          "Partita $gameNumber\nPesci catturati: ${controller.score}",
